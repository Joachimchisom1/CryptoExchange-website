 ...
 <table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0" class="forTexts"> 
 	<tr> 
 		<td width=100% height=100% valign=top>    
 			<h4>Delete User <hr /></h4>
 			

 			<!-- ////////////////////////////// -->
 			<?php
 			if(isset($_GET['exit_group'])){
 					$class->paywase_deletemainnuser();
 				}
 				if(isset($_GET['delete_user'])){
 					$suer_id = $_GET['delete_user'];
 					$class->delete_user($suer_id);
      ...
      <!-- <form method="post"> -->
 			<!-- <table cellspacing=0 cellpadding=2 border=0 width=100%> 
 				<tr> 
 					...
 					<td align=left style="order:1px solid #fff;"> </td> 
 				</tr>
 				<tr> 
 				...
 				<tr> 
 					...
 					<td align=left style="order:1px solid #fff;"><input type="text"  name="hash_id" placeholder="enter transaction batch" style=" width:100%;border:2px solid #ff8d3a;"></td> 
 				</tr>
