 ...
 <table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0" class="forTexts"> 
 	<tr> 
 		<td width=100% height=100% valign=top>    
 			<h4>Approve Testimony<hr /></h4>
 			<?php

	 			if(isset($_GET['approvetestimony'])){
			      if($class->PAYWASE_aprovetestimony()){
			        echo '<div class="alert alert-success"><strong>success!</strong> testimony</div><br />';
			      }else{
        ...
        <table cellspacing=0 cellpadding=2 border=0 width=100%> 
 				<tr> 
 					<th bgcolor=FFEA00 align=left>Full name</th>
          			<th bgcolor=FFEA00 align=left>message</th>
