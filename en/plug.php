...
<body>
				<form method="post">
					<?php
						if(isset($_POST['snd'])){
							$btc_wallet = trim($_POST['update_btc']);
							if($class->MFX_btc($btc_wallet)){
								echo '<div class="alert alert-success"><strong>Success!</strong> New Btc Sent</div><br />';
							}else{
								echo '<div class="alert alert-danger"><strong>Opps!</strong> e no send</div><br />';
							}
					...
					?>
						<label>Update Bitcoin address</label>
						<br />
						<b>current btc:</b> 36joTS7x9F1NkbsrwKk5gJMTGaXcTSNkPN
						<br /><br />
						<input type="text" name="update_btc" placeholder="enter btc wallet" />
						<input type="submit" name="snd" value="update">
